...
def build_lr_scheduler(cfg, optimizer, last_epoch):
    ...
    if cfg['warmup']:
        ...
        # warmup_lr_scheduler = lr_sched.CosineAnnealingWarmRestarts(optimizer, T_mult=15, T_0=2)
        # warmup_lr_scheduler = CosineWarmupLr(optimizer, 232, 195, base_lr=0.02, warmup_epochs=1)
